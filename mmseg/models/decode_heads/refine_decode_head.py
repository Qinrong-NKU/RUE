...
class RefineBaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def forward_train(self, inputs, img_metas, gt_semantic_seg, train_cfg):
        ...
        losses,mask = self.losses(seg_logits, gt_semantic_seg)
        fm_decoder.append(losses['loss_seg'].detach().clone())
    ...
    def losses(self, seg_logit, seg_label):
        ...
        loss['acc_seg'],mask = accuracy1(seg_logit, seg_label)
        return loss,mask
