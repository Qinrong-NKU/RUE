    ...
    def get_gt_seg_maps(self, efficient_test=False):
        ...
        for img_info in self.img_infos:
            ...
            if efficient_test:
                ...
                gt_seg_map=self.convert_rgb_to_id(label=gt_seg_map)
            gt_seg_maps.append(gt_seg_map)
        return gt_seg_maps
    
    def convert_rgb_to_id(self, label,rgb2id={0:[0, 0, 0], 1:[0, 255, 255], 2:[255, 255, 0], 3:[255, 0, 255], 4:[0, 255, 0],
        ...
        for classnum, color in rgb2id.items():
